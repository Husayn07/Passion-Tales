...
async function loadCategories() {
    try {
        ...
        // Create filter buttons
        filtersContainer.innerHTML = categoriesData.map(cat => `
            <button class="filter-btn ${cat.slug === currentCategory ? 'active' : ''}" 
                    data-category="${cat.slug}"
                    style="${cat.slug !== 'all' ? `--cat-color: ${cat.color}` : ''}"
                    aria-label="Filter by ${cat.name}">
                ${cat.name} <span class="count">(${cat.count})</span>
        ...
        filtersContainer.innerHTML = `
            ...
            <button class="filter-btn ${currentCategory === 'first-time' ? 'active' : ''}" 
                    data-category="first-time">First Time</button>
            <button class="filter-btn ${currentCategory === 'workplace' ? 'active' : ''}" 
                    data-category="workplace">Workplace</button>
        `;
...
// Set category filter and update URL
